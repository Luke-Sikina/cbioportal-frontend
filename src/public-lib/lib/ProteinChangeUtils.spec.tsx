...
describe("ProteinChangeUtils", () => {
  ...
  describe("getProteinPositionFromProteinChange", () => {
    it("gets correct protein position from protein change", () => {
      ...
      assert.deepEqual(getProteinPositionFromProteinChange("P177_C182del"), {
        start: 177,
        end: 182
      });
      assert.deepEqual(
      ...
      assert.deepEqual(getProteinPositionFromProteinChange("V272_R273insL"), {
        start: 272,
        end: 273
      });
      ...
      assert.deepEqual(getProteinPositionFromProteinChange("X332_splice"), {
        start: 332,
        end: 332
      });
    });
