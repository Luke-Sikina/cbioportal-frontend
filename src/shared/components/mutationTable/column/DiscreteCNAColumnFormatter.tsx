...
export default class DiscreteCNAColumnFormatter {
  ...
  protected static getTdContents(cacheDatum: DiscreteCNACacheDataType | null) {
    ...
    if (
      ...
      if (alteration === 2) {
        return (
          <span style={{ color: "red", textAlign: "center", fontSize: "12px" }}>
            <b>Amp</b>
          </span>
        );
        ...
        return (
          <span
            style={{ color: "red", textAlign: "center", fontSize: "smaller" }}
          >
            <b>Gain</b>
          </span>
        );
        ...
        return (
          <span
            style={{ color: "blue", textAlign: "center", fontSize: "smaller" }}
          >
            <b>ShallowDel</b>
          </span>
        );
        ...
        return (
          <span
            style={{ color: "blue", textAlign: "center", fontSize: "12px" }}
          >
            <b>DeepDel</b>
          </span>
        );
