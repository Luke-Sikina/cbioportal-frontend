...
export default class ExonColumnFormatter {
      ...
      if (exonData == null) {
        ...
        return (
          <span style={{ display: "inline-block", float: "right" }}>
            <span style={{ float: "left", width: "24px", textAlign: "right" }}>
              {" "}
              {exonData.split("/")[0]}{" "}
            </span>
            {showTotalNumberOfExons && (
  ...
  public static getData(
    ...
    const exon =
      genomeNexusData.annotation_summary.transcriptConsequenceSummary.exon;
    if (exon) {
      return exon;
    } else {
  ...
  public static download(
    ...
    const exonData =
      genomeNexusData && ExonColumnFormatter.getData(genomeNexusData.data);
