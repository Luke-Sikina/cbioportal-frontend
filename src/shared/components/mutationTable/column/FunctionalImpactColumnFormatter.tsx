  ...
  public static mutationAssessorText() {
    return (
      <div style={{ width: 450, height: 100 }}>
        ...
        such as mutations discovered in cancer or missense polymorphisms. The
  ...
  public static siftText() {
    return (
      <div style={{ width: 450, height: 100 }}>
        ...
        SIFT can be applied to naturally occurring nonsynonymous polymorphisms
...
export default class FunctionalImpactColumnFormatter {
  ...
  public static renderFunction(
    ...
    const genomeNexusCacheData = FunctionalImpactColumnFormatter.getGenomeNexusDataFromCache(
      data,
      genomeNexusCache
    );
    return (
  ...
  public static download(
    ...
    const genomeNexusData = FunctionalImpactColumnFormatter.getGenomeNexusDataFromCache(
      data,
      genomeNexusCache
    );
    const functionalImpactData =
      genomeNexusData &&
      FunctionalImpactColumnFormatter.getData(genomeNexusData.data);
