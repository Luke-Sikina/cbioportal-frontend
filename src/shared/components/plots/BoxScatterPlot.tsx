    ...
    if (this.props.legendData && this.props.legendData.length) {
      ...
      return (
        <VictoryLegend
          ...
          itemsPerRow={
            this.legendLocation === "right" ? undefined : LEGEND_ITEMS_PER_ROW
          }
  ...
  @computed get boxWidthDataSpace() {
    return (
      ...
      (this.props.horizontal
        ? (this.plotDomain.y[1] - this.plotDomain.y[0]) / this.chartHeight
        : (this.plotDomain.x[1] - this.plotDomain.x[0]) / this.chartWidth)
    );
  }
    ...
    return (
      <VictoryAxis
        ...
        tickLabelComponent={
          <VictoryLabel
            angle={
              this.props.horizontal ? undefined : CATEGORY_LABEL_HORZ_ANGLE
            }
        ...
        axisLabelComponent={
          <VictoryLabel
            dy={this.props.horizontal ? 35 : this.biggestCategoryLabelSize + 24}
          />
        }
      />
    );
    ...
    if (this.container && this.tooltipModel && this.props.tooltip) {
      return (
        <ScatterPlotTooltip
          ...
          targetCoords={{
            x: this.tooltipModel.x + this.leftPadding,
            y: this.tooltipModel.y + this.topPadding
          }}
