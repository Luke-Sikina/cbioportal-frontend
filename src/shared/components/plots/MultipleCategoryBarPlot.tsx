...
> {
  ...
  @computed get horzAxis() {
    ...
    if (this.props.horizontalBars) {
      label.unshift(
        `${this.props.countAxisLabel}${this.props.percentage ? " (%)" : ""}`
      );
    }
    ...
    return (
      <VictoryAxis
        ...
        label={label}
        tickValues={
          this.props.horizontalBars ? undefined : this.categoryTickValues
        }
        ...
        tickLabelComponent={
          <VictoryLabel
            angle={
              this.props.horizontalBars ? undefined : CATEGORY_LABEL_HORZ_ANGLE
            }
  ...
  @computed get vertAxis() {
    ...
    return (
      <VictoryAxis
        ...
        dependentAxis={true}
        tickValues={
          this.props.horizontalBars ? this.categoryTickValues : undefined
        }
