  ...
  readonly vusWarning = MakeMobxView({
    ...
    render: () => {
      ...
      if (this.props.mutationsTabModeSettings) {
        ...
        const mutationReport = this.props.store.oqlFilteredMutationsReport
          .result!;
        const mutationVusCount =
          mutationReport.vus.length + mutationReport.vusAndGermline.length;
        const cnaVusCount = this.props.store.oqlFilteredMolecularDataReport
          .result!.vus.length;
          ...
          return (
            <div className="alert alert-info">
              <img
                ...
                style={{ marginRight: 6, width: 15, marginTop: -2 }}
              />
              {this.excludeVUS
                ? `${vusCount} ${getVusDescription(
                    vusTypes,
              ...
              {this.vusToggleable && (
                <button
                  onClick={
                    this.props.mutationsTabModeSettings!.toggleExcludeVUS
                  }
