...
import {
  GnomadData,
  frequencyOutput
} from "../mutationTable/column/GnomadColumnFormatter";
    ...
    return [
      ...
      <td>
        <DefaultTooltip
          ...
          overlay={
            <span>
              Number of times any allele has been observed at this position in
              the population
            </span>
          }
        >
    ...
    this.props.data.forEach(d => {
      ret.push(
        <tr>
          ...
          <td>{d.homozygotes}</td>
          <td data-test="allele-frequency-data">
            {frequencyOutput(d.alleleFrequency)}
          </td>
        </tr>
      );
    });
  ...
  public render() {
    ...
    return (
      <div className="cbioportal-frontend">
        <SimpleTable headers={this.getHeaders()} rows={this.getRows()} />
        <div
          style={{ fontSize: "x-small", textAlign: "center", paddingTop: 5 }}
        >
