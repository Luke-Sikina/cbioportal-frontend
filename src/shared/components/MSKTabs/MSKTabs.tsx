    ...
    return (
      <div
        ...
        className={classnames(
          { "msk-tab": true, hiddenByPosition: !!this.props.inactive },
    ...
    if (this.props.children && React.Children.count(this.props.children)) {
      ...
      const targetTabId = (() => {
        if (
          ...
          return (toArrayedChildren[0] as React.ReactElement<IMSKTabProps>)
            .props.id;
        }
      })();
        ...
        pages[currentPage - 1].push(
          ...
          >
            <a
              ...
              href={
                this.props.getTabHref && this.props.getTabHref(tab.props.id)
              }
