...
describe("MutationMapperDataStore", () => {
  ...
  it("toggles selections correctly, selects mutations by position, and gives them in sorted order", () => {
    ...
    store.setSelectionFilters([{ position: [5] }]);
    assert.deepEqual(
      store.sortedFilteredData,
    ...
    store.setSelectionFilters([{ position: [5, 10] }]);
    assert.deepEqual(
      store.sortedFilteredData,
      [[pos10Mutation], [pos5Mutation], [pos20Mutation]],
    ...
    store.setSelectionFilters([{ position: [5, 10, 20] }]);
    assert.deepEqual(
      store.sortedFilteredData,
      [[pos10Mutation], [pos20Mutation]],
    ...
    store.setSelectionFilters([{ position: [20] }]);
    assert.deepEqual(
      store.sortedFilteredSelectedData,
      [[pos20Mutation]],
  ...
  it("implements isPositionSelected", () => {
    ...
    store.setSelectionFilters([{ position: [1] }]);
    ...
    store.setSelectionFilters([{ position: [1, 3] }]);
    ...
    store.setSelectionFilters([{ position: [1, 3, 5] }]);
    ...
    store.setSelectionFilters([{ position: [1, 3, 5, 20] }]);
    ...
    store.setSelectionFilters([{ position: [1, 5, 20] }]);
