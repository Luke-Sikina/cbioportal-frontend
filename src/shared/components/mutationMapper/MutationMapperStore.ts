...
export default class MutationMapperStore extends DefaultMutationMapperStore {
  ...
  readonly mutationData = remoteData(
    {
      await: () => {
        if (
          this.mutationMapperStoreConfig.filterMutationsBySelectedTranscript
        ) {
  ...
  protected customFilterApplier(
    ...
    if (pick && filter.hotspot && this.indexedHotspotData.result) {
