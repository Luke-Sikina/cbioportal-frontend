...
> extends DefaultMutationMapper<P> {
  ...
  @computed get trackDataStatus(): TrackDataStatus {
    ...
    let alignmentDataStatus: "pending" | "error" | "complete" | "empty" = this
      .props.store.alignmentData.status;
    ...
    let ptmDataStatus: "pending" | "error" | "complete" | "empty" = this.props
      .store.ptmData.status;
