    ...
    return (
      <table className={styles.mutationTypeTable}>
        <tr>
          <td>
            {mutationTypeButton(
              proteinImpactTypeToCount[ProteinImpactType.MISSENSE],
              "Missense",
          ...
          <td>
            {mutationTypeButton(
              proteinImpactTypeToCount[ProteinImpactType.TRUNCATING],
              "Truncating",
        ...
        <tr>
          <td>
            {mutationTypeButton(
              proteinImpactTypeToCount[ProteinImpactType.INFRAME],
              "Inframe",
          ...
          <td>
            {mutationTypeButton(
              proteinImpactTypeToCount[ProteinImpactType.OTHER],
              "Other",
