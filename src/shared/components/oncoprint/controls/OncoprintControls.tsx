            ...
            {showTreatmentsTextArea &&
              this.props.state.treatmentsPromise!.isComplete && [
                <TextIconArea
                  ...
                  onChangeTextArea={this.onChangeTreatmentTextArea}
            ...
            {!this.props.state.hideClusterHeatmapButton && (
              <button
                ...
                className={classNames("btn", "btn-sm", "btn-default", {
                  active: this.props.state.clusterHeatmapButtonActive
                })}
          ...
          <div className="checkbox">
            <label>
              <input
                ...
                disabled={!this.props.state.distinguishMutationType}
              />{" "}
              Mutation Type
            </label>
          </div>
                  ...
                  <label>
                    ...
                    {this.props.state.annotateDriversOncoKbError && (
                      <ErrorIcon
                        ...
                        tooltip={
                          <span>
                            Error loading OncoKb data. Please refresh the page
                            or try again later.
                          </span>
                        }
                      />
                ...
                !this.props.state.annotateDriversHotspotsDisabled && (
                  <div className="checkbox">
                    <label>
                      ...
                      />
                      {this.props.state.annotateDriversHotspotsError && (
                        <ErrorIcon
                          style={{ marginRight: 4 }}
                          tooltip={
                            <span>
                              Error loading Hotspots data. Please refresh the
                      ...
                      <DefaultTooltip
                        overlay={
                          <div style={{ maxWidth: "400px" }}>
                            Identified as a recurrent hotspot (statistically
                            significant) in a population-scale cohort of tumor
                            samples of various cancer types using methodology
                            based in part on{" "}
                            <a
            ...
            <div className="checkbox">
              <label>
                <input
                  ...
                  disabled={!this.props.state.distinguishDrivers}
                />{" "}
                Hide mutations and copy number alterations of unknown
                significance
              </label>
            </div>
            <div className="checkbox">
  ...
  private getViewMenuOncoprint() {
    return (
      <CustomDropdown bsStyle="default" title="View" id="viewDropdownButton">
        ...
        <div className="checkbox" style={{ marginLeft: 20, maxWidth: 220 }}>
          <label>
            <input
            ...
            {this.props.state.columnMode === "patient" ? "patients" : "samples"}
            .
          </label>
        </div>
        <div className="checkbox">
  ...
  private getHorzZoomControls() {
    return (
      <div className="btn btn-default oncoprint__zoom-controls">
        ...
        <DefaultTooltip overlay={<span>Zoom in/out of oncoprint.</span>}>
