...
describe("alterationCountHelpers", () => {
  describe("#countAlterationOccurences", () => {
    ...
    it("uses alterationSubType to evaluate MRNA direction", () => {
      ...
      assert.equal(
        ret["Hepatobiliary Cancer"].alterationTypeCounts.mrnaExpressionLow,
        1
      );
      assert.equal(
        ret["Hepatobiliary Cancer"].alterationTypeCounts.mrnaExpressionHigh,
        1
      );
    });
    ...
    it("uses alterationSubType to evaluate PROT direction", () => {
      ...
      assert.equal(
        ret["Hepatobiliary Cancer"].alterationTypeCounts.protExpressionLow,
        1
      );
      assert.equal(
        ret["Hepatobiliary Cancer"].alterationTypeCounts.protExpressionHigh,
        1
      );
    });
  });
