...
} from "public-lib/api/generated/Genome2StructureAPI";
import {
  CosmicMutation,
...
export function findMutationMolecularProfileId(
  molecularProfilesInStudy: MobxPromise<MolecularProfile[]>,
  studyId: string,
...
export function findUncalledMutationMolecularProfileId(
  ...
  return findMutationMolecularProfileId(
...
export function findMrnaRankMolecularProfileId(
  ...
  const preferredProfile:
    | MolecularProfile
    | undefined = molecularProfilesInStudy.result.find((gp: MolecularProfile) =>
