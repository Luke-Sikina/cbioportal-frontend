...
describe("OQL parser", () => {
  ...
  doTest("TP53: GERMLINE_SOMATIC", [
    {
      gene: "TP53",
      alterations: [
        { alteration_type: "mut", info: {}, modifiers: ["GERMLINE", "SOMATIC"] }
      ]
    }
  ]);
    ...
    [
      {
        ...
        alterations: [
          ...
          },
          {
            ...
            constr_val: "INFRAME",
            info: {},
            modifiers: ["GERMLINE", "SOMATIC", "DRIVER"]
          },
          {
            alteration_type: "mut",
            constr_rel: "=",
            ...
            constr_val: "INFRAME",
            info: {},
            modifiers: ["GERMLINE", "DRIVER", "SOMATIC"]
          },
          {
            alteration_type: "mut",
            constr_rel: "=",
            ...
            constr_val: "NONSENSE",
            info: {},
            modifiers: ["DRIVER", "SOMATIC", "GERMLINE"]
          },
          {
            alteration_type: "mut",
            info: {},
  ...
  doTest("TP53:SOMATIC GERMLINE_PROMOTER", [
    {
      gene: "TP53",
      alterations: [
        { alteration_type: "mut", info: {}, modifiers: ["SOMATIC"] },
        {
          alteration_type: "mut",
          constr_rel: "=",
          constr_type: "class",
  ...
  doTest(
    "TP53:DRIVER GERMLINE_DRIVER DRIVER_GERMLINE TRUNC_DRIVER DRIVER_MISSENSE INFRAME_DRIVER_GERMLINE DRIVER_GERMLINE_INFRAME",
    [
      {
        gene: "TP53",
        alterations: [
