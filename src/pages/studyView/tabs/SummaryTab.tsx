  ...
  constructor(props: IStudySummaryTabProps) {
    ...
    this.handlers = {
      ...
      updateChartSampleIdentifierFilter: (
        ...
        this.store.updateChartSampleIdentifierFilter(
          uniqueKey,
          cases,
          keepCurrent
        );
  ...
  renderAttributeChart = (chartMeta: ChartMeta) => {
    ...
    switch (this.store.chartsType.get(chartMeta.uniqueKey)) {
      ...
      case BAR_CHART: {
        ...
        props.filters = this.store.getClinicalDataIntervalFiltersByUniqueKey(
          chartMeta.uniqueKey
        );
          ...
          this.showErrorMessage && (
            <div>
              <div className="alert alert-danger">
                ...
                The following sample(s) might have been deleted/updated with the
                recent data updates
                <br />
                <ul
                  style={{
