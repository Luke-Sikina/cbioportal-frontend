    ...
    return (
      <div>
        ...
        <div style={{ marginBottom: 15, marginLeft: 15 }}>
          <span>
            {this.hasNoSegmentData ? "No segmented" : "Segmented"} copy-number
        ...
        <div
          style={
            this.isHidden || this.hasNoSegmentData ? { opacity: 0 } : undefined
          }
        >
          <IntegrativeGenomicsViewer
            ...
            isVisible={
              this.props.store.currentTab ===
                StudyViewPageTabKeyEnum.CN_SEGMENTS && !this.isHidden
            }
          />
        </div>
      </div>
