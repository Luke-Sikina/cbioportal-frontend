...
import {
  ...
  CopyNumberCountByGeneWithCancerGene
...
class CNAGenesTableComponent extends FixedHeaderTable<
  CopyNumberCountByGeneWithCancerGene
> {}
...
export class CNAGenesTable extends React.Component<ICNAGenesTablePros, {}> {
  @observable
  private preSelectedRows: CNAGenesTableUserSelectionWithIndex[] = [];
  ...
  get tableColumns() {
    return [
      ...
      },
      {
        ...
        tooltip: (
          <span>
            Copy number alteration, only amplifications and deep deletions are
            shown
          </span>
        ),
        render: (data: CopyNumberCountByGeneWithCancerGene) => (
      ...
      },
      {
        ...
        tooltip: (
          <span>Number of samples with the listed copy number alteration</span>
        ),
        headerRender: () => {
          return (
      ...
      },
      {
        ...
        tooltip: (
          <span>
            Percentage of samples with the listed copy number alteration
          </span>
        ),
        headerRender: () => {
          return (
  ...
  isSelectedRow(data: CopyNumberCountByGeneWithCancerGene) {
    return !_.isUndefined(
      _.find(_.union(this.selectedRows, this.preSelectedRows), function(row) {
        return (
          row.entrezGeneId === data.entrezGeneId &&
          row.alteration === data.alteration
        );
      })
    );
  }
