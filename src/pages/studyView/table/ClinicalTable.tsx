...
> {
  ...
  private _columns = [
    ...
    },
    {
      ...
      headerRender: () => {
        return (
          <div style={{ marginLeft: this.cellMargin[ColumnKey.NUMBER] }}>#</div>
        );
      },
      render: (data: ClinicalDataCountSummary) => (
        <LabeledCheckbox
      ...
      tooltip: (
        <span>
          Number of {this.props.patientAttribute ? "patients" : "samples"}
        </span>
      ),
    ...
    },
    {
      ...
      tooltip: (
        <span>
          Percentage of {this.props.patientAttribute ? "patients" : "samples"}
        </span>
      ),
      filter: (d: ClinicalDataCountSummary, f: string) => {
