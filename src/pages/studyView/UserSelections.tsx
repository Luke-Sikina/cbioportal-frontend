            ...
            <div className={styles.parentGroupLogic}>
              <GroupLogic
                components={[
                  ...
                  <GroupLogic
                    components={clinicalDataEqualityFilter.values.map(label => {
                      return (
                        <PillTag
                          content={label}
                          backgroundColor={
              ...
              <GroupLogic
                components={[
                  ...
                  <PillTag
                    ...
                    onDelete={() =>
                      this.props.updateClinicalDataIntervalFilter(chartMeta, [])
                    }
                  />
                ]}
                operation={":"}
                          ...
                          <PillTag
                            ...
                            onDelete={() =>
                              this.props.updateCustomChartFilter(
                                chartMeta,
                                _.remove(content, value => value !== label)
                              )
                            }
                          />
                        );
              ...
              return (
                <GroupLogic
                  components={filter.alterations.map(filter => {
                    ...
                    tagColor =
                      tagColor === undefined ? DEFAULT_NA_COLOR : tagColor;
                    return (
                      <PillTag
                        content={
                          hugoGeneSymbol === undefined
                            ? `Entrez Gene ID: ${filter.entrezGeneId}`
                            : hugoGeneSymbol
                        }
