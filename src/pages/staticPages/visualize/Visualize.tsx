      ...
      <PageLayout className={"whiteBackground staticPage"}>
        ...
        <ul>
          <li>
            ...
            <a href="https://github.com/cBioPortal/cbioportal">GitHub</a> under
            the terms of Affero GPL V3.
          </li>
          <li>
            Please note that, installing a local version requires system
            administration skills, for example, installing and configuring
            Tomcat and MySQL. With limited resources, we cannot provide
            technical support on system administration.
          </li>
        </ul>
        ...
        <ul>
          <li>
            Public data will be available to everyone. Suggestions on data sets
            are welcome.
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            is an open source software company that provides commercial support
            for cBioPortal. They can help with deployment, data loading,
            development, consulting and training. Please{" "}
        ...
        <h2>
          The following tools are for visualization and analysis of custom
          datasets
        </h2>
        ...
        <div style={{ display: "flex" }} className={styles.toolArray}>
          ...
          <div>
            ...
            <p>
              Maps mutations on a linear protein and its domains (lollipop
              plots). <a href="mutation_mapper">Try it!</a>
            </p>
