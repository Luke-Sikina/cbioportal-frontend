...
> {
    ...
    return (
      <PageLayout className={"whiteBackground staticPage"}>
        ...
        <div className="cbioportal-frontend">
          <h1 style={{ display: "inline" }}>MutationMapper</h1> interprets
          mutations with protein annotations
          <div style={{ padding: 4 }} />
          {this.input()}
          <div style={{ padding: 4 }} />
          <Loader
    ...
    if (
      ...
      return (
        <div className="alert alert-warning" role="alert">
          Failed to annotate {this.store.mutationsNotAnnotated.length} mutation
          ...
          (
          <a data-test="ShowWarningsButton" onClick={this.toggleIncorrectInput}>
  ...
  protected mainTabs() {
    if (
      ...
      return (
        <div className="alert alert-danger">
          Critical annotation error. Annotation services might be temporarily
          down, or your input format might be invalid.
        </div>
      );
    } else {
      return null;
    ...
    if (this.inputControlsVisible) {
      return (
        <div className="standalone-mutation-input">
          <p>
            Please input <b>tab-delimited</b> or <b>space-delimited</b> mutation
            data. (Load example data:
            <span>
              {" "}
              <a
                onClick={this.handleLoadExampleGenomicCoordinates}
            ...
            <span>
              {" "}
              <a
                onClick={this.handleLoadExampleGeneAndProteinChange}
            ...
            <span>
              {" "}
              <a
                onClick={this.handleLoadExamplePartiallyAnnotated}
      ...
      <p>
        ...
        <Collapse isOpened={!this.dataFormatCollapsed}>
          <div className="mutation-data-info">
            ...
            <div className="full-list-of-headers">{this.inputFormatDesc()}</div>
          </div>
        </Collapse>
      </p>
    );
    ...
    return (
      <div className="mutation-input-format-info">
        <p>
          ...
          select a file with mutation data for upload.
          <br />
        </p>
        <p>
          Mutation files should be tab delimited, and should at least have the
          genomic location headers in the first line for a successful
          annotation. Note that all variants have to be reported for genome
          build GRCh37 (hg19).
        </p>
        <ul>
          <li>Chromosome</li>
        ...
        <p>
          If your mutation input doesn't contain the genomic location headers,
          but you still want to visualize your data, your input should at least
      ...
      <table className="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              Lowest numeric position of the reported variant on the genomic
              reference sequence
            </td>
            <td>666</td>
          </tr>
          <tr>
            <td>End_Position</td>
            <td>
              Highest numeric position of the reported variant on the genomic
              reference sequence
            </td>
            <td>667</td>
          </tr>
