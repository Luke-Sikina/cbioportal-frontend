...
> {
  ...
  protected generateColumns() {
    ...
    this._columns[MutualExclusivityTableColumnType.NEITHER] = {
      ...
      tooltip: (
        <span>Number of samples with alterations in neither A nor B</span>
      ),
    ...
    this._columns[MutualExclusivityTableColumnType.A_NOT_B] = {
      ...
      tooltip: (
        <span>Number of samples with alterations in A but not in B</span>
      ),
    ...
    this._columns[MutualExclusivityTableColumnType.B_NOT_A] = {
      ...
      tooltip: (
        <span>Number of samples with alterations in B but not in A</span>
      ),
    ...
    this._columns[MutualExclusivityTableColumnType.LOG_ODDS_RATIO] = {
      ...
      tooltip: (
        <span style={{ display: "inline-block", maxWidth: 300 }}>
          Quantifies how strongly the presence or absence of alterations in A
          are associated with the presence or absence of alterations in B in the
          selected samples. OR = (Neither * Both) / (A Not B * B Not A)
        </span>
      ),
    ...
    this._columns[MutualExclusivityTableColumnType.Q_VALUE] = {
      ...
      tooltip: (
        <span>Derived from Benjamini-Hochberg FDR correction procedure</span>
      ),
