...
export default class Network extends React.Component<INetworkTabParams, {}> {
  ...
  @computed get url() {
    ...
    )}/reactapp/network/network.htm?${
      AppConfig.serverConfig.app_version
    }&apiHost=${encodeURIComponent(
      AppConfig.apiRoot!.replace(/^http[s]?:\/\//, "")
    )}#${strParams}`;
  }
    ...
    return (
      <>
        <div className={"alert alert-info"}>
          The Network tab will be retired on 11/1/2019. For similar
