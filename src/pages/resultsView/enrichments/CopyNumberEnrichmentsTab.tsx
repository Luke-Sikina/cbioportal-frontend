  ...
  readonly tabUI = MakeMobxView({
    ...
    render: () => {
      ...
      if (studies.length === 1) {
        profileName =
          " - " +
          this.props.store.selectedMutationEnrichmentProfileMap.result![
            studies[0].studyId
          ].name;
      }
        ...
        <div data-test="CopyNumberEnrichmentsTab">
          <EnrichmentsDataSetDropdown
            ...
            selectedProfileByStudyId={
              this.props.store.selectedCopyNumberEnrichmentProfileMap.result!
            }
          ...
          <AlterationEnrichmentContainer
            data={this.props.store.copyNumberHomdelEnrichmentData.result!}
            groups={[
              {
                name: "Altered group",
              ...
              },
              {
                ...
                count: patientLevel
                  ? this.props.store.unalteredPatientKeys.result!.length
          ...
          <hr />
          <AlterationEnrichmentContainer
            data={this.props.store.copyNumberAmpEnrichmentData.result!}
            groups={[
              {
                name: "Altered group",
                description: `Number (percentage) of ${
