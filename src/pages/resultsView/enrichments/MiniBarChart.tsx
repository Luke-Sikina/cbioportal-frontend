        ...
        <div style={{ display: "flex", flexDirection: "row" }}>
          ...
          >
            ...
            >
              ...
              <VictoryBar
                data={[
                  { x: 2, y: this.props.totalAlteredCount, index: 0 },
                  {
                    x: 4,
                    y: this.props.selectedGene
              ...
              <VictoryBar
                data={[
                  { x: 2, y: 0 },
                  { x: 4, y: this.props.selectedGene ? totalCount * 0.001 : 0 }
                ]}
                style={{ data: { width: barWidth } }}
              />
              <VictoryBar
              ...
              <VictoryBar
                data={[
                  { x: 2, y: this.props.totalUnalteredCount, index: 1 },
                  {
                    x: 4,
                    y: this.props.selectedGene
            ...
            <VictoryAxis
              ...
              style={{
                ...
                tickLabels: { padding: 2, fontSize: 12, fill: "black" },
