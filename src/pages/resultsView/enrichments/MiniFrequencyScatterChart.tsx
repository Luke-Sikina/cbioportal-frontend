...
} from "../../../public-lib/lib/TextTruncationUtils";
...
> {
  ...
  private svgRef(svgContainer: SVGElement | null) {
    this.svgContainer =
      svgContainer && svgContainer.children ? svgContainer.children[0] : null;
  }
    ...
    if (this.tooltipModel) {
      return (
        ...
        >
          ...
          p-Value:{" "}
          {toConditionalPrecision(this.tooltipModel.datum.pValue, 3, 0.01)}
          <br />
          q-Value:{" "}
          {toConditionalPrecision(this.tooltipModel.datum.qValue, 3, 0.01)}
        </Popover>
      );
    } else {
      return <span />;
        ...
        >
          ...
          >
            ...
            <VictoryLine
              ...
              data={[
                { x: 0, y: 0 },
                { x: this.plotDomainMax, y: this.plotDomainMax }
              ]}
            />
            <VictoryScatter
              style={{
