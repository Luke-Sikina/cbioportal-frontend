...
export class AlterationEnrichmentTableComponent extends LazyMobXTable<
  AlterationEnrichmentRow
> {}
...
> {
  ...
  @computed get columns(): {
    ...
    const columns: { [columnEnum: string]: AlterationEnrichmentTableColumn } =
    ...
    columns[AlterationEnrichmentTableColumnType.ALTERATION] = {
      ...
      render: (d: AlterationEnrichmentRow) => (
        <span
          style={{ color: d.value! === 2 ? CNA_COLOR_AMP : CNA_COLOR_HOMDEL }}
        >
  ...
  public render() {
    ...
    return (
      <AlterationEnrichmentTableComponent
