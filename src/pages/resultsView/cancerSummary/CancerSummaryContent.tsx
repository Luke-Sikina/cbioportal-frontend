...
> {
  ...
  @observable private pdf: { anchor: string; width: number; height: number } = {
    anchor: "",
    width: 0,
    height: 0
  };
  ...
  determineSorterAndDirection(): {
    ...
    if (this.xAxis === "x-axis") {
      ...
      sorter =
        this.yAxis === "abs-count" ? sortByAbsoluteCount : sortByPercentage;
      dir = "desc" as "desc";
    }
    return { sorter, dir };
  }
            ...
            if (
              ...
              maxPercentage =
                alterationPercentage > maxPercentage
                  ...
                  : maxPercentage;
              maxAbsoluteCount =
                alterationData.alteredSampleCount > maxAbsoluteCount
                  ? alterationData.alteredSampleCount
                  : maxAbsoluteCount;
              maxSampleCount =
                alterationData.profiledSampleTotal > maxSampleCount
                  ? alterationData.profiledSampleTotal
                  : maxSampleCount;
              ...
              <div className="slider-holder">
                <div className="slider custom-labels">
                  <Slider
                    ...
                    labels={{
                      0: 0 + symbol,
                      [this.altCasesMax]: Math.ceil(this.altCasesMax) + symbol
                    }}
            ...
            <div data-test="cancerTypesSummaryDiv">
              ...
              <div
                className={classnames("alert", "alert-success", {
                  hidden: !this.totalCaseChanged && !this.altCaseChanged
                })}
              >
