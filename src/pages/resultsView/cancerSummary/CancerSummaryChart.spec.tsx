...
describe("CancerSummaryChart", () => {
  it("Allows chart container to be horizontally scrolled when bar threshold is reached", () => {
    ...
    result = method
      .bind({ props: { xLabels: Array(HORIZONTAL_SCROLLING_THRESHOLD + 1) } })
      .call();
  ...
  it("#mergeAlterationDataAcrossAlterationTypes should merge alteration rate/count across alteration types", () => {
    let alterationData = [
      [
        { alterationType: "multiple", x: "Colorectal Adenocarcinoma", y: 0 },
        {
          alterationType: "multiple",
      ...
      [
        ...
        { alterationType: "protExpressionLow", x: "Colon Adenocarcinoma", y: 0 }
      ],
      [
        {
          alterationType: "protExpressionHigh",
      ...
      [
        ...
        { alterationType: "mrnaExpressionLow", x: "Colon Adenocarcinoma", y: 0 }
      ],
      [
        {
          alterationType: "mrnaExpressionHigh",
      ...
      [
        { alterationType: "fusion", x: "Colorectal Adenocarcinoma", y: 0 },
