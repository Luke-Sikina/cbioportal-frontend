          ...
          <div>
            <div>
              <a
                ...
                className={classNames({ hidden: !this.hasUnselectedStudies })}
                ...
                <div className={classNames("checkbox", { disabled: !hasData })}>
                  <label>
                    <input
                      type="checkbox"
                      checked={
                        hasData && this.selectedStudyIds[study.studyId] === true
                      }
                      value={study.studyId}
                      disabled={!hasData}
                    ...
                    {!hasData && (
                      <span
                        className="badge badge-info small"
                        style={{ marginLeft: 5 }}
                      >
                        {"No Expr. Data"}
                      </span>
                  ...
                  <div className="posRelative">
                    ...
                    {this.mutationDataExists.result && (
                      <div style={{ marginTop: 20 }}>
                        * Driver annotation settings are located in the Mutation
                        Color menu of the Oncoprint.
                      </div>
                    )}
                  </div>
                </Then>
