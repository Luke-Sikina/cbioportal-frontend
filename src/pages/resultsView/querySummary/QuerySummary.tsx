...
export default class QuerySummary extends React.Component<
  {
    ...
    onToggleQueryFormVisiblity: (visible: boolean) => void;
  },
  {}
> {
  @autobind
      ...
      return (
        <div>
          ...
          <span>
            ...
            in {this.props.store.queriedStudies.result.length} studies
            &nbsp;-&nbsp;
            {getGeneSummary(this.props.store.hugoGeneSymbols)}
            &nbsp;
            <DefaultTooltip
    ...
    return (
      <div style={{ margin: "10px -20px 0 -20px" }}>
        <QueryAndDownloadTabs
          ...
          getQueryStore={() =>
            createQueryStore(getBrowserWindow().routingStore.query)
          }
        />
      </div>
    );
