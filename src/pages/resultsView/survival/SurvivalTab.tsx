        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <div style={{ width: "920px" }}>
            <SurvivalChart
              ...
              patientSurvivals={
                this.overallPatientSurvivalData.result.patientSurvivals
              }
              analysisGroups={analysisGroups}
              patientToAnalysisGroups={
                this.overallPatientSurvivalData.result.patientToAnalysisGroups
              }
        ...
        <div>
          ...
          <div style={{ width: "920px" }}>
            <SurvivalChart
              className="borderedChart"
              patientSurvivals={
                this.diseaseFreePatientSurvivalData.result.patientSurvivals
              }
              analysisGroups={analysisGroups}
              patientToAnalysisGroups={
