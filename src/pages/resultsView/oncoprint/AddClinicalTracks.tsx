...
> {
  ...
  readonly options = remoteData({
    ...
    invoke: () => {
      ...
      const availableFrequency = this.clinicalAttributeIdToAvailableFrequency
        .result!;
        ...
        [
          (x: ClinicalAttribute) => {
            if (x.clinicalAttributeId === SpecialAttribute.StudyOfOrigin) {
              ...
              x.clinicalAttributeId === SpecialAttribute.MutationSpectrum
            ) {
              return 1;
      ...
      return Promise.resolve(
        _.mapValues(sortedAttributes, attrs => {
          return attrs.map(attr => ({
            ...
            selected:
              attr.clinicalAttributeId in this.selectedClinicalAttributeIds
          }));
        })
      );
    }
