          ...
          this.resultsViewPageStore.isQueryInvalid && (
            ...
            >
              <p>
                ...
                your use case(s) if you need to query more than 100 genes.
              </p>
            </div>
          )}
          {this.resultsViewPageStore.studies.isComplete && (
          ...
          {this.resultsViewPageStore.studies.isComplete && (
            <div>
              ...
              this.showTabs &&
                ...
                !this.resultsViewPageStore.isQueryInvalid && (
                  <MSKTabs
                    key={this.resultsViewPageStore.rvQuery.hash}
