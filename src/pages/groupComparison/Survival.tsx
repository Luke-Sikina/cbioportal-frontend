        ...
        for (const group of this.props.store.activeGroups.result!) {
          ...
          for (const identifier of patientIdentifiers) {
            ...
            if (samples && samples.length) {
              patientToAnalysisGroups[samples[0].uniquePatientKey] = [
                group.uid
              ];
            }
          }
  ...
  readonly tabUI = MakeMobxView({
    ...
    render: () => {
      ...
      if (this.props.store._activeGroupsNotOverlapRemoved.result!.length > 10) {
        ...
        this.props.store._activeGroupsNotOverlapRemoved.result!.length === 0
      ) {
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            <div style={{ width: "920px" }}>
              <SurvivalChart
                ...
                patientSurvivals={
                  this.props.store.overallPatientSurvivals.result
                }
