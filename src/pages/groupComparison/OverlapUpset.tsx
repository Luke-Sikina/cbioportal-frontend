...
export interface IOverlapUpsetProps {
  ...
  sideBySide: boolean;
  maxWidth: number;
  samplesVennPartition: { key: { [uid: string]: boolean }; value: string[] }[];
  patientsVennPartition: { key: { [uid: string]: boolean }; value: string[] }[];
      ...
      >
        ...
        >
          <UpSet
            ...
            onChangeSelectedCombinations={this.changeSelectedSampleRegions}
            selectedCombinations={this.sampleSelection}
          />
          {this.sampleUpset && this.props.samplesVennPartition.length > 0 && (
        ...
        >
          <UpSet
            ...
            onChangeSelectedCombinations={this.changeSelectedPatientRegions}
            selectedCombinations={this.patientSelection}
          />
          {this.patientUpset && this.props.patientsVennPartition.length > 0 && (
            <CreateGroupFromOverlap
              store={this.props.store}
