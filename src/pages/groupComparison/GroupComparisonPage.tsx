        ...
        >
          ...
          {this.store.showSurvivalTab && (
            <MSKTab
              ...
              linkText="Survival"
              anchorClassName={
                this.store.survivalTabUnavailable ? "greyedOut" : ""
              }
            >
          ...
          {this.store.showMutationsTab && (
            <MSKTab
              ...
              linkText="Mutations"
              anchorClassName={
                this.store.mutationsTabUnavailable ? "greyedOut" : ""
              }
            >
          ...
          {this.store.showCopyNumberTab && (
            <MSKTab
              ...
              anchorClassName={
                this.store.copyNumberUnavailable ? "greyedOut" : ""
              }
            >
          ...
          {this.store.showProteinTab && (
            <MSKTab
              ...
              linkText="Protein"
              anchorClassName={
                this.store.proteinTabUnavailable ? "greyedOut" : ""
              }
            >
